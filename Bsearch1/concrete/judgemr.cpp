...
void judgemr0(int a1,int a2)
{
	if(e[a2]==e[a1]+1&&b[a1][0]==b[a2][0])
	{
		...
		result[resulti][1]=a2;
		result[resulti][2]=0;
		if(y[a1][0]==-1||y[a2][0]==-1||y[a2][0]==y[a1][1]+1)
		result[resulti][3]=1;
		else
		result[resulti][3]=0;
		resulti++;
...
{
	if(e[a2]==e[a1]&&b[a1][0]+1==b[a2][0])
	{
		if(b[a2][0]>=2&&b[a2][2]>b[a2][1]&&e[a2]!=b[a2][1])
		{
			for(int i=1;i<=b[a1][0];i++)
		    {
			if(b[a1][i]!=b[a2][i+1])
		    ...
		    result[resulti][1]=a2;
		    result[resulti][2]=1;
		    if((y[a1][0]==-1&&y[a2][0]==-1)||(y[a1][0]+1==y[a2][0]&&y[a1][1]+1==y[a2][1]))
		    result[resulti][3]=1;
		    else
		    result[resulti][3]=0;
		    resulti++;
